...
public class Command extends BaseSpiritorCard {

    public static final String ID = makeID("Command"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(m, p, new SoulTargetPower(m)));
    }
}
