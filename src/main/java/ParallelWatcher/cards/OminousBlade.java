...
import ParallelWatcher.cards.SoulCards.ImpendingDoom;
import ParallelWatcher.character.ParallelWatcher;
import ParallelWatcher.util.CardStats;
import com.megacrit.cardcrawl.characters.AbstractPlayer;
import com.megacrit.cardcrawl.monsters.AbstractMonster;

public class OminousBlade extends BaseSpiritorCard {

    public static final String ID = makeID("OminousBlade"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new PlaceActualCardIntoOrb(new ImpendingDoom()));
    }
