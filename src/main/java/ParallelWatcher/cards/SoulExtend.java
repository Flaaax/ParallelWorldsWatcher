...
public class SoulExtend extends BaseSpiritorCard {
    public static final String ID = makeID("SoulExtend");
    private static final int OrbSlot = 2;
    public static final int UPG_OrbSlot = 1;
    ...
    public void upgrade() {
        if (!upgraded) {
            upgradeName();
            upgradeMagicNumber(UPG_OrbSlot);
        }
    }
