...
import ParallelWatcher.powers.MarkExplosionPower;
...
public class MarkExplosion extends BaseSpiritorCard {

    public static final String ID = makeID("MarkExplosion");
    private static final int MARK = 11;
    private static final int UPG_MARK = 4;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(m, p, new MarkExplosionPower(m, 1)));
        if (m != null) {
